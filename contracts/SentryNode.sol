...
//             require(licenceOwner[licenses[i]]  == msg.sender, "Sentry/registerNodeAccount: not license owner");
//             require(licenceOperator[licenses[i]].length == 0, "Sentry/registerNodeAccount: licence already registered");
