...
function testFuzz_DecompressPublicKey(bytes calldata pubKey) public pure returns (LibSecp256k1.Point memory) {
    LibSecp256k1.Point memory p =  LibSecp256k1Extended.decompressPublicKey(pubKey);
    console.log("POINTTTTT", p.x, p.y);
    return p;
}
